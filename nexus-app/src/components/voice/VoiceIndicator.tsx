...
export function VoiceIndicator({
  ...
  useEffect(() => {
    ...
    // Try to get real microphone input
    ...
    const startRealVisualization = () => {
      const updateLevels = () => {
        ...
        const binSize = Math.floor(dataArrayRef.current.length / 20);
        ...
        for (let i = 0; i < 20; i++) {
          ...
          let level = (sum / binSize / 255) * 100 * settings.sensitivity;
